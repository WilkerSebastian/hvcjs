...
$parcel$export(module.exports, "HVC", () => $391b2ac8d45cfcf0$export$8a43600249637a28);
$parcel$export(module.exports, "HVM", () => $9c134ae509f26de3$export$2e2bcd8739ae039);
$parcel$export(module.exports, "Calculadora", () => $af512031ecd1dbb9$export$2e2bcd8739ae039);
$parcel$export(module.exports, "Chico", () => $18312d35ba7353b6$export$2e2bcd8739ae039);
$parcel$export(module.exports, "EPI", () => $e20cd15754767e15$export$2e2bcd8739ae039);
$parcel$export(module.exports, "FolhaDeSaida", () => $3ad49f4f7d0f2ca4$export$2e2bcd8739ae039);
$parcel$export(module.exports, "Gaveteiro", () => $58cd5cf8946ec542$export$2e2bcd8739ae039);
$parcel$export(module.exports, "PortaCartoes", () => $803b90235097da40$export$2e2bcd8739ae039);
class $af512031ecd1dbb9$export$2e2bcd8739ae039 {
    soma(valor) {
...
class $18312d35ba7353b6$export$2e2bcd8739ae039 {
...
class $e20cd15754767e15$export$2e2bcd8739ae039 {
    registrar(registro) {
...
class $3ad49f4f7d0f2ca4$export$2e2bcd8739ae039 {
    imprimir(texto) {
        if (this.saida) {
            this.saida(texto);
            return;
...
function $afc58b7dd33f4e03$export$e772c8ff12451969(ms) {
    return new Promise((resolve)=>setTimeout(resolve, ms));
}


class $58cd5cf8946ec542$export$2e2bcd8739ae039 {
    ...
    async carga(portaCartao, delay) {
        ...
        let final = false;
        while(!final){
            if (delay > 0) await (0, $afc58b7dd33f4e03$export$e772c8ff12451969)(delay);
...
class $803b90235097da40$export$2e2bcd8739ae039 {
...
class $5b399f423c2ed297$export$2e2bcd8739ae039 {
}


class $24a96940d8eb837b$export$2e2bcd8739ae039 {
...
class $316f3b90cc190700$export$2e2bcd8739ae039 extends (0, $24a96940d8eb837b$export$2e2bcd8739ae039) {
    constructor(type, value){
        super(type, value);
    }
    getType() {
...
class $12c73e41dbc7b155$export$2e2bcd8739ae039 extends (0, $5b399f423c2ed297$export$2e2bcd8739ae039) {
    lexer(script) {
        let token = null;
        ...
        for(let i = 0; i < words.length; i++){
            ...
            if (!end) {
                if (/^000$/.test(word)) {
                    ...
                    token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("000", 0);
                } else if (/^0[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("0EE", parseInt(word.substring(1, 3)));
                else if (/^1[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("1EE", parseInt(word.substring(1, 3)));
                else if (/^2[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("2EE", parseInt(word.substring(1, 3)));
                else if (/^3[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("3EE", parseInt(word.substring(1, 3)));
                else if (/^4[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("4EE", parseInt(word.substring(1, 3)));
                else if (/^5[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("5EE", parseInt(word.substring(1, 3)));
                else if (/^6[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("6EE", parseInt(word.substring(1, 3)));
                else if (/^7[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("7EE", parseInt(word.substring(1, 3)));
                else if (/^8[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("8EE", parseInt(word.substring(1, 3)));
                else if (/^9[0-9]{2}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("9EE", parseInt(word.substring(1, 3)));
                else if (/^0-[0-9]{1,3}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("0-N", parseInt(word.match(/[0-9]{1,3}$/)[0]));
                else throw new Error(`Erro de sintaxe, instru\xe7\xe3o ${word} n\xe3o \xe9 conhecida!`);
            } else {
                if (/^[0-9]{3}$/.test(word)) token = new (0, $316f3b90cc190700$export$2e2bcd8739ae039)("DATA", parseInt(word));
...
class $9c134ae509f26de3$export$2e2bcd8739ae039 {
    async run(code) {
    ...
    async executable() {
        const syntax = new (0, $12c73e41dbc7b155$export$2e2bcd8739ae039)();
        await this.chico.carga(this.gaveteiro, this.portaCartoes, this.delay);
        do {
            if (this.delay > 0 && this.state != "WAIT") await (0, $afc58b7dd33f4e03$export$e772c8ff12451969)(this.delay);
    ...
    constructor(){
        this.state = "ENDED";
        this.calculadora = new (0, $af512031ecd1dbb9$export$2e2bcd8739ae039)();
        this.chico = new (0, $18312d35ba7353b6$export$2e2bcd8739ae039)();
        this.epi = new (0, $e20cd15754767e15$export$2e2bcd8739ae039)();
        this.folhaDeSaida = new (0, $3ad49f4f7d0f2ca4$export$2e2bcd8739ae039)();
        this.gaveteiro = new (0, $58cd5cf8946ec542$export$2e2bcd8739ae039)();
        this.portaCartoes = new (0, $803b90235097da40$export$2e2bcd8739ae039)();
        this.delay = 0;
    }
}
...
class $391b2ac8d45cfcf0$export$8a43600249637a28 {
    constructor(){
        this.isDebug = false;
        this.HVM = new (0, $9c134ae509f26de3$export$2e2bcd8739ae039)();
        this.code = "";
    }
    addEventInput(call) {
        this.input = call;
